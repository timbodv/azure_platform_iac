...
New-AzTenantDeployment -TemplateFile .\tenant_management_groups.bicep -Location australiaeast

New-AzManagementGroupDeployment -ManagementGroupId lab-mg -Location australiaeast -TemplateFile .\plz.bicep
